...
export const metadata: Metadata = generateMetadata({
  ...
  description: "Explore the latest Toyota Hybrid & SUV range at Laxmi Toyota. Book online, apply for finance, or request exchange evaluation from Berhampur, Jeypore, Rayagada, and Bhawanipatna.",
  canonicalUrl: "/",
});

export default function HomePage() {
  const featuredVehicles = [
    { name: "Toyota Glanza", type: "Hatchback", price: "Starting from ₹6.86 Lakh*", badge: "Sporty", isHybrid: false },
    { name: "Toyota Taisor", type: "Compact SUV", price: "Starting from ₹7.74 Lakh*", badge: "New Launch", isHybrid: false },
    { name: "Toyota Rumion", type: "MPV", price: "Starting from ₹10.44 Lakh*", badge: "Family SUV", isHybrid: false },
    { name: "Toyota Hyryder", type: "Hybrid SUV", price: "Starting from ₹11.14 Lakh*", badge: "Strong Hybrid Available", isHybrid: true },
    { name: "Toyota Innova Crysta", type: "Premium MPV", price: "Starting from ₹19.99 Lakh*", badge: "Legendary Comfort", isHybrid: false },
    { name: "Toyota Innova Hycross", type: "Hybrid MPV", price: "Starting from ₹19.77 Lakh*", badge: "Self-Charging Hybrid", isHybrid: true },
    { name: "Toyota Fortuner", type: "Legendary SUV", price: "Starting from ₹33.43 Lakh*", badge: "Off-Road Legend", isHybrid: false }
  ];
  ...
  return (
    <Layout>
        ...
        <Container className="grid grid-cols-1 gap-12 lg:grid-cols-2 lg:items-center">
          <div className="flex flex-col gap-6 text-left">
            ...
            <h1 className="text-4xl font-extrabold tracking-tight text-[#111111] sm:text-5xl lg:text-6xl leading-tight">
              Drive Home the Future of Mobility in Odisha
            </h1>
            <p className="text-lg text-gray-600 max-w-xl">
              Experience the legendary reliability of Toyota. Book online, apply for financing, or request a certified trade-in evaluation easily from your device.
            </p>
          ...
          {/* Aesthetic CSS Graphic representing Toyota SUV line */}
          <div className="relative flex items-center justify-center rounded-3xl bg-gradient-to-tr from-gray-900 via-gray-800 to-black p-8 lg:p-12 shadow-2xl overflow-hidden aspect-video">
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(235,10,30,0.15),transparent)] pointer-events-none" />
            <div className="relative flex flex-col gap-4 text-center z-10 text-white">
              <Car className="h-16 w-16 text-[#EB0A1E] mx-auto animate-bounce" />
              <h3 className="text-xl font-bold tracking-tight">Toyota SUV & Hybrid Range</h3>
              <p className="text-sm text-gray-400 max-w-xs mx-auto">
                Discover Glanza, Hyryder, Innova Hycross, and Fortuner with standard-setting safety and efficiency.
              </p>
            </div>
          </div>
        </Container>
        ...
        <Container>
          ...
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
            {featuredVehicles.map((veh) => (
              ...
              >
                {/* Visual Graphic Representation instead of broken images */}
                <div className="h-48 bg-gradient-to-b from-gray-50 to-gray-100 flex flex-col items-center justify-center p-6 border-b border-gray-100 relative overflow-hidden">
                  <Car className="h-12 w-12 text-gray-400 group-hover:text-[#EB0A1E] transition-colors duration-300" />
                  <span className="text-xs font-semibold text-gray-500 mt-3">{veh.badge}</span>
                  {veh.isHybrid && (
      ...
      {/* 3. Why Choose Laxmi Toyota Section */}
      ...
      {/* 5. South Odisha Coverage Section */}
      <Section className="bg-gray-50 border-t border-b border-gray-100">
        <Container>
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            {faqs.map((faq, i) => (
              <div key={i} className="p-6 bg-gray-50 rounded-2xl border border-gray-150 flex flex-col gap-2">
                <h3 className="font-bold text-lg text-[#111111] flex items-center gap-2">
                  <HelpCircle className="h-5 w-5 text-[#EB0A1E]" /> {faq.q}
                </h3>
      ...
      <section className="bg-[#111111] text-white py-16 border-t-2 border-red-600">
